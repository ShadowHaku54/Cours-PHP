...
<body>
    <div class="sidebar">
        ...
        <nav class="menu">
            ...
            <a href="?page=5" class="active"><i class="icon-notifications"></i> Notifications</a>
    ...
    <div class="main-content">
        <h1>Liste des dettes non payées</h1>
            ...
            <table>
                ...
                <tbody>
                    <tr>
                        ...
                        <td>2024-12-31</td>
                        <td>En retard</td>
                        <td><button class="send-button">Envoyer</button></td>
                    </tr>
                    <tr>
                        <td class="checkbox-cell"><input type="checkbox"></td>
                        <td>NDIAYE</td>
